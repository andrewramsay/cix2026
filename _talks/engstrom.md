---
name: Computational human driving behavior reference models for ADS evaluation based on (en)active inference 
speakers:
  - JohanEngstrom
track: Track A
---
*Title:* Computational human driving behavior reference models for ADS evaluation based on (en)active inference
